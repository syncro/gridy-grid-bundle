...
var HgTemplateEngine = function () {
    function HgTemplateEngine(handlebars) {
        classCallCheck(this, HgTemplateEngine);

        this.handlebars = handlebars;
    }

    createClass(HgTemplateEngine, [{
        key: 'renderString',
        ...
        value: function render(tpl, data) {
            if ((typeof tpl === 'undefined' ? 'undefined' : _typeof(tpl)) === 'object') {
...
var BaseTemplateEngine = function () {
    function BaseTemplateEngine() {
        classCallCheck(this, BaseTemplateEngine);
    }

    createClass(BaseTemplateEngine, [{
...
var Renderer = function () {
    ...
    createClass(Renderer, [{
        ...
        value: function confFromEl(el) {
            ...
            try {
                for (var _iterator = Object.keys(RD_SHARED_ATTRS)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function mountTemplate(path, id, hostEl, preRenData) {
            ...
            return new Promise(function (resolve, reject) {
                var el = _this.findTemplateEl(id, hostEl);

                if (el !== null) {
                    var elInstance = document.importNode(el, true);
                    // can be mustache or native template inlined and overriden
                    if (_this.variableRender && _this.templateEngine && preRenData) {
                        elInstance.innerHTML = _this.templateEngine.render(elInstance.innerHTML, preRenData);
                    }
                    resolve(elInstance);
                } else {
                    _this.loadTemplate(path).then(function (body) {
                        var template = _this.findTemplateEl(id, hostEl);
                        if (!template) {
                            if (_this.tplFmt == 'handlebars') {
                                template = _this.createEl('script');
                                template.setAttribute('type', 'text/x-handlebars-template');
                            } else {
                                template = _this.createEl('template');
                            }
                        }
                        template.setAttribute('id', id);
                        template.innerHTML = body;
                        if (_this.cacheTemplates) {
                            el = _this.findTemplateEl(id, hostEl);
                            if (_this.allowGlobalTemplates) {
                        ...
                        if (_this.variableRender && _this.templateEngine && preRenData) {
                            var contents = _this.templateEngine.render(body, preRenData);
        ...
        value: function prepareTemplate(tpl) {
            if (this.tplFmt && this.tplFmt == 'handlebars') {
                var html = this.jquery(tpl.innerHTML).prop('outerHTML');
        ...
        value: function renderTemplate(sl, dataMap) {
            ...
            try {
                for (var _iterator2 = Object.keys(dataMap)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var _sl = _step2.value;
                    ...
                    if (el !== null) {
                        ...
                        console.warn('Element with selector ' + _sl + ' not found in DOM');
                    }
                }
            } catch (err) {
                _didIteratorError2 = true;
        ...
        value: function renderMustacheVars(el, map) {
            ...
            try {
                for (var _iterator3 = Object.keys(map)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        value: function localizeEl(targetEl, locale) {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this2.translations[locale]) {
                    fetch(self.basePath + '/theme/' + _this2.theme + '/i18n/' + 'gridy-i18n-' + locale + '.json').then(function (response) {
                    ...
                    resolve(self.renderWithTr(_this2.translations[locale], targetEl));
                }
            });
        }
    }, {
        ...
        value: function hasRenderAttrs(el) {
            ...
            try {
                for (var _iterator4 = Object.keys(RD_SHARED_ATTRS)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        value: function configureForElement(el) {
            if (!el.renderer) {
                ...
                if (Renderer.hasRenderAttrs(el)) {
                    ...
                    try {
                        for (var _iterator5 = Object.keys(RD_SHARED_ATTRS)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
var GridyFilter = function (_HTMLElement) {
    inherits(GridyFilter, _HTMLElement);

    function GridyFilter() {
        classCallCheck(this, GridyFilter);
        return possibleConstructorReturn(this, (GridyFilter.__proto__ || Object.getPrototypeOf(GridyFilter)).apply(this, arguments));
    }

    createClass(GridyFilter, [{
        key: 'changeFilter',
        ...
        value: function connectedCallback() {
            ...
            if (this.dataSource) {
                this.dataSource.addEventListener('dataLoaded', function (event) {});
            }
            if (this.basePath) {
                var context = this;
                this.renderer.mountTemplate(this.tplPath, 'filterTpl', this, context).then(function (templateEl) {
                    _this2.tpl = templateEl;
                    _this2.appendChild(_this2.renderer.prepareTemplate(_this2.tpl));
                    if (_this2.dataSource) {
                        var input = _this2.querySelector('input');
                        if (input != null) {
                            input.addEventListener('input', _this2.changeFilter.bind(_this2));
                        }
                    }
                });
            }
...
var GridyPager = function (_HTMLElement) {
    inherits(GridyPager, _HTMLElement);

    function GridyPager() {
        classCallCheck(this, GridyPager);
        return possibleConstructorReturn(this, (GridyPager.__proto__ || Object.getPrototypeOf(GridyPager)).apply(this, arguments));
    }

    createClass(GridyPager, [{
        key: 'onclick',
        value: function onclick(event) {
            // get current or parent data-num attr value
            var numAttr = event.target.dataset.num || event.target.parentElement.dataset && event.target.parentElement.dataset.num;
            if (!numAttr) {
                event.preventDefault();
                event.stopPropagation();
                return null;
            }
            var backPaged = event.target.dataset.backPaged || event.target.parentElement.dataset.backpaged;
            var detail = {
                page: this.curPageNum, backPaged: backPaged
            };
            var sortField = event.target.dataset.sortfield || event.target.parentElement.dataset.sortfield;
            var sort = undefined;
            if (sortField) {
                sort = {};
                var sortDirection = event.target.dataset.sortdirection || event.target.parentElement.dataset.sortdirection;
                sort.sortField = detail.sortField = sortField;
                sort.sortDirection = detail.sortDirection = sortDirection;
            }
            var num = parseInt(numAttr);
            if (num !== 0) {
                this.curPageNum = detail.page = num;
                this.dispatchEvent(new CustomEvent('pageChanged', { detail: detail }));
                if (!backPaged) {
        ...
        value: function renderPageButton(num, backPaged, sort) {
            var _this2 = this;

            var context = Object.assign({ num: num }, this);
            var path = num === this.curPageNum ? this.itemActiveTplPath : this.itemTplPath;
            var templateId = num === this.curPageNum ? 'pagerActiveItemTpl' : 'pagerItemTpl';
            this.renderer.mountTemplate(path, templateId, this, context).then(function (templateEl) {
                var wrap = _this2.renderer.prepareTemplate(templateEl);
                var button = wrap.tagName === 'LI' ? wrap : wrap.querySelector('li');
                ...
                _this2.querySelector('ul').appendChild(button);
                _this2.dispatchEvent(new CustomEvent('pagerButtonRendered'));
            });
        }
    }, {
        key: 'renderButtons',
        value: function renderButtons(backPaged, sort) {
            var _this3 = this;

            var context = this;
            Promise.all([this.renderer.mountTemplate(this.bodyTplPath, 'pagerBodyTpl', this, context), this.renderer.mountTemplate(this.itemTplPath, 'pagerItemTpl', this), this.renderer.mountTemplate(this.itemActiveTplPath, 'pagerActiveItemTpl', this)]).then(function (templateEls) {
                _this3.bodyTpl = templateEls[0];
                _this3.bodyEl = _this3.renderer.prepareTemplate(_this3.bodyTpl);
                _this3.innerHTML = '';
                _this3.appendChild(_this3.bodyEl);

                if (_this3.totalPages >= 5) {
                    if (_this3.curPageNum > 2) {
                        if (_this3.curPageNum + 2 < _this3.totalPages) {
                            // middle pages
                            for (var i = _this3.curPageNum - 2; i <= _this3.curPageNum + 2; i++) {
                                _this3.renderPageButton(i, backPaged, sort);
                            }
                        } else {
                            // last pages
                            for (var _i = _this3.curPageNum - 2; _i <= _this3.totalPages; _i++) {
                                _this3.renderPageButton(_i, backPaged, sort);
                            }
                        }
                    } else {
                        // start pages, big resultset
                        for (var _i2 = 1; _i2 <= 5; _i2++) {
                            _this3.renderPageButton(_i2, backPaged, sort);
                        }
                    }
                } else {
                    //start pages, small resultset
                    for (var _i3 = 1; _i3 <= _this3.totalPages; _i3++) {
                        _this3.renderPageButton(_i3, backPaged, sort);
                    }
                }
                _this3.dispatchEvent(new CustomEvent('pagerRendered'));
            });
        }
    }, {
        key: 'initPageButtons',
        value: function initPageButtons(data, backPaged, sort) {
            ...
            if (this.dataSource) {
                this.dataSource.addEventListener('dataLoaded', function (event) {
                    if (event.detail.totalResults) {
                        _this4.totalResults = event.detail.totalResults;
                        _this4.totalPages = Math.ceil(_this4.totalResults / _this4.perPage);
                    }
                    var data = event.detail.data;
                    var backPaged = event && event.detail.backPaged || undefined;
                    var sort = { sortField: event.detail.sortField, sortDirection: event.detail.sortDirection };
                    _this4.initPageButtons(data, backPaged, sort);
                });
        ...
        set: function set$$1(totalResults) {
...
var DataSourceLocal = function (_EventTarget) {
    inherits(DataSourceLocal, _EventTarget);

    //data: [];
    //loadTimest: number;
    //dataPath: string; // jsonpath for data rows root;

    function DataSourceLocal() {
        classCallCheck(this, DataSourceLocal);

        var _this = possibleConstructorReturn(this, (DataSourceLocal.__proto__ || Object.getPrototypeOf(DataSourceLocal)).call(this));

        _this.loadTimest = -1;
        return _this;
    }

    createClass(DataSourceLocal, [{
        key: 'init',
        value: function init() {}
    }, {
        key: 'loadData',
        value: function loadData(data, params) {
            this.dispatchEvent(new CustomEvent('dataLoadStarted', {
                detail: params
            }));
            params = params || {};
            var dataRows = this.dataPath ? jsonPath(data, this.dataPath)[0] : data;
        ...
        value: function sort(field, direction) {
            var sortFunc = function sortFunc(a, b) {
                ...
                if (field && field.startsWith('$')) {
                    aVal = jsonPath(a, field)[0];
                    bVal = jsonPath(b, field)[0];
                } else {
                    aVal = a[field];
                    bVal = b[field];
                }
        ...
        value: function filter(value) {
            ...
            this.dataFiltered = this._data.filter(function (dataItem) {
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;

                try {
                    for (var _iterator = _this2.fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        if (typeof field == 'string') {
                            ...
                            var result = jsonPath(dataItem, field.path)[0];
                            if (result !== null) {
                                var itemValue = result.toString();
                                if (Array.isArray(value)) {
                                    var _iteratorNormalCompletion3 = true;
                                    var _didIteratorError3 = false;
                                    var _iteratorError3 = undefined;
                                    ...
                                    try {
                                        for (var _iterator3 = value[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                            ...
                                            if (itemValue && itemValue.indexOf(_val) >= 0) {
                                                return true;
                                            }
                                        }
                                    } catch (err) {
...
var XmlHttpClient = function () {
    function XmlHttpClient() {
        classCallCheck(this, XmlHttpClient);
    }

    createClass(XmlHttpClient, [{
        key: 'request',
        ...
        value: function request(url) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (_this.auth && _this.auth.type === 'basic') {
                    xhr.setRequestHeader("Authorization", "Basic " + btoa(_this.auth.username + ':' + _this.auth.password));
                }
        ...
        key: 'get',
        value: function get$$1(url, contentType) {
...
var DataSourceAjax = function (_DataSourceLocal) {
    inherits(DataSourceAjax, _DataSourceLocal);
    ...
    function DataSourceAjax() {
        classCallCheck(this, DataSourceAjax);

        var _this = possibleConstructorReturn(this, (DataSourceAjax.__proto__ || Object.getPrototypeOf(DataSourceAjax)).call(this));
    ...
    createClass(DataSourceAjax, [{
        ...
        value: function buildUrl(params) {
            ...
            if (params.backPaged) {
                var url = this.url + '?page=' + page + '&perPage=' + perPage;
                if (params.sortField) {
        ...
        value: function fetchData(params) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this2.dispatchEvent(new CustomEvent('dataFetchStarted', {
                    detail: params
                }));
                _this2.http.get(_this2.buildUrl(params)).then(function (request) {
                    _this2.dispatchEvent(new CustomEvent('dataFetched', {
                        detail: params
                    }));
                    ...
                    var detail = {
                        ...
                        totalResults: response.totalResults || _this2.data.length
                    };
                    ...
                    _this2.loadData(_this2.data, detail);
                    resolve(_this2.data);
                });
            });
        }
    }]);
    return DataSourceAjax;
}(DataSourceLocal);

var GridyDataSource = function (_HTMLElement) {
    inherits(GridyDataSource, _HTMLElement);

    function GridyDataSource() {
        classCallCheck(this, GridyDataSource);
        return possibleConstructorReturn(this, (GridyDataSource.__proto__ || Object.getPrototypeOf(GridyDataSource)).apply(this, arguments));
    }

    createClass(GridyDataSource, [{
        key: 'config',
        value: function config() {
            var dataSourceType = this.getAttribute('data-source-type');
            if (!dataSourceType) {
            ...
            if (this.getAttribute('fields')) {
                ...
                var fieldEls = this.querySelectorAll('gridy-data-field');
                var fields = [];
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;
                ...
                try {
                    for (var _iterator = fieldEls[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var fieldEl = _step.value;

                        var field = {};
                        field.title = fieldEl.getAttribute('title');
                        field.path = fieldEl.getAttribute('path');
                        var fmt = fieldEl.getAttribute('fmt');
                        if (fmt) {
                            field.fmt = fmt;
                        }
                        var html = fieldEl.getAttribute('html');
                        if (html) {
                            field.html = html;
                        }
                        fields.push(field);
    ...
    return GridyDataSource;
}(HTMLElement);

var GridyTable = function (_HTMLElement) {
    inherits(GridyTable, _HTMLElement);

    function GridyTable() {
        classCallCheck(this, GridyTable);
        return possibleConstructorReturn(this, (GridyTable.__proto__ || Object.getPrototypeOf(GridyTable)).apply(this, arguments));
    }

    createClass(GridyTable, [{
        key: 'changeSort',
        value: function changeSort(event) {
            var oldSortField = this.sortField;
            var newSortField = event.target.dataset.sort;
            ...
            var headRow = event.target.parentElement;
            if (headRow !== null) {
        ...
        key: 'bindHeadingEvents',
        value: function bindHeadingEvents(row) {
            if (this.onhrowclick && typeof this.onhrowclick === 'function') {
                row.addEventListener('click', this.onhrowclick.bind(this));
            }
        }
    }, {
        key: 'renderHeaderContents',
        value: function renderHeaderContents() {
            this.headEl = this.renderer.prepareTemplate(this.headTpl);

            var row = this.headEl.querySelector('tr') || this.renderer.createEl('tr');
            ...
            try {
                for (var _iterator2 = this.dataSource.fields[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var field = _step2.value;

                    var headCell = this.renderer.createEl('th');
                    if (typeof field == 'string') {
            ...
            if (this.getAttribute('sort-field')) {
            ...
            var headEl = this.tableEl.querySelector('thead');
            if (headEl != null) {
                headEl = this.headEl;
            } else {
        ...
        value: function renderHeaders() {
            ...
            var context = this;
            this.renderer.mountTemplate(this.headTplPath, 'tableHeadTpl', this, context).then(function (templateEl) {
                _this2.headTpl = templateEl;
                _this2.renderHeaderContents();
            });
        }
    }, {
        key: 'bindRowEvents',
        value: function bindRowEvents(row) {
        ...
        key: 'renderRow',
        value: function renderRow(bodyEl, dataItem) {
            var row = this.renderer.createEl('tr');
            ...
            try {
                for (var _iterator3 = this.dataSource.fields[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var field = _step3.value;

                    var cell = this.renderer.createEl('td');

                    var value = this.specCellContents(field, dataItem, cell);
        ...
        key: 'specCellContents',
        value: function specCellContents(field, dataItem, cell) {
            var value = '';
            if (typeof field == 'string') {
        ...
        key: 'specCellAtts',
        value: function specCellAtts(field, cell, value) {
            if (field.attr) {
                var _iteratorNormalCompletion4 = true;
                var _didIteratorError4 = false;
                var _iteratorError4 = undefined;
                ...
                try {
                    for (var _iterator4 = Object.keys(field.attr)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var attrName = _step4.value;

                        var attrValue = field.attr[attrName];
        ...
        key: 'specRowAttrs',
        value: function specRowAttrs(field, row, value) {
            if (field.rowattr) {
                var _iteratorNormalCompletion5 = true;
                var _didIteratorError5 = false;
                var _iteratorError5 = undefined;
                ...
                try {
                    for (var _iterator5 = Object.keys(field.rowattr)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        var attrName = _step5.value;

                        var attrValue = field.rowattr[attrName];
                        if (typeof attrValue == 'string') {
        ...
        key: 'renderBody',
        value: function renderBody(data, backPaged) {
            var tbody = this.querySelector('tbody');
            if (tbody != null) {
                tbody.innerHTML = '';
            } else {
                var bodyEl = this.renderer.prepareTemplate(this.bodyTpl);
            ...
            if (this.pager) {
                ...
                var end = start + this.pager.perPage;
                ...
                try {
                    for (var _iterator7 = data[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                        var _dataItem = _step7.value;

                        this.renderRow(tbody, _dataItem);
                    }
                } catch (err) {
        ...
        value: function changePage(event) {
            var backPaged = event.detail.backPaged;
            var pageNum = event.detail.page;
            var detail = {
                backPaged: backPaged,
                page: pageNum
            };
        ...
        value: function renderData(event) {
            ...
            var data = event && event.detail.data || this.dataSource.data;
            this.backPaged = event && event.detail.backPaged;

            var context = this;

            this.renderer.mountTemplate(this.bodyTplPath, 'tableBodyTpl', this, context).then(function (templateEl) {
                _this3.bodyTpl = templateEl;
                _this3.renderBody(data, _this3.backPaged);
            });
        }
    }, {
        key: 'bindDataSource',
        value: function bindDataSource(dataSource) {
            if (dataSource) {
        ...
        value: function connectedCallback() {
            ...
            if (this.filters) {
                ...
                try {
                    for (var _iterator8 = this.filters[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
            ...
            this.tableEl = this.querySelector('table') || this.renderer.createEl('table');
        ...
        set: function set$$1(sortDirection) {
...
var GridyTableInfo = function (_HTMLElement) {
    inherits(GridyTableInfo, _HTMLElement);

    function GridyTableInfo() {
        classCallCheck(this, GridyTableInfo);
        return possibleConstructorReturn(this, (GridyTableInfo.__proto__ || Object.getPrototypeOf(GridyTableInfo)).apply(this, arguments));
    }

    createClass(GridyTableInfo, [{
        key: 'changePage',
        ...
        value: function buildContext() {
            var from = (this.pager.curPageNum - 1) * this.pager.perPage;
            var to = from + this.pager.perPage;
            var total = 0;
            if (event && event.target.type === 'pageChanged') {
        ...
        key: 'renderData',
        value: function renderData(loadByPage) {
            var _this2 = this;
            ...
            this.renderer.mountTemplate(path, id, this).then(function (templateEl) {
                _this2.tpl = templateEl;
                var el = _this2.renderer.prepareTemplate(templateEl);

                var map = _this2.buildContext();

                if (_this2.lang) {
                    _this2.renderer.localizeEl(el, _this2.lang).then(function (translatedEl) {
                        _this2.innerHTML = '';
                        _this2.insertAdjacentHTML('beforeend', _this2.renderer.templateEngine.render(translatedEl, map));
                        _this2.dispatchEvent(new CustomEvent('tableInfoRendered'));
                    });
                } else {
                    _this2.innerHTML = '';
                    _this2.insertAdjacentHTML('beforeend', _this2.renderer.templateEngine.render(el, map));
                    _this2.dispatchEvent(new CustomEvent('tableInfoRendered'));
                }
            });
        }
    ...
    return GridyTableInfo;
}(HTMLElement);

var GridySpinner = function (_HTMLElement) {
    inherits(GridySpinner, _HTMLElement);

    function GridySpinner() {
        classCallCheck(this, GridySpinner);
        return possibleConstructorReturn(this, (GridySpinner.__proto__ || Object.getPrototypeOf(GridySpinner)).apply(this, arguments));
    }

    createClass(GridySpinner, [{
        key: 'show',
        value: function show() {
        ...
        value: function connectedCallback() {
            ...
            var context = this;
            this.renderer.mountTemplate(this.tplPath, 'spinnerTpl', this, context).then(function (templateEl) {
                _this2.tpl = templateEl;
                var el = _this2.renderer.prepareTemplate(_this2.tpl);
...
var GridyDataField = function (_HTMLElement) {
  inherits(GridyDataField, _HTMLElement);

  function GridyDataField() {
    classCallCheck(this, GridyDataField);
    return possibleConstructorReturn(this, (GridyDataField.__proto__ || Object.getPrototypeOf(GridyDataField)).apply(this, arguments));
  }

  return GridyDataField;
}(HTMLElement);

var GridyGrid = function (_HTMLElement) {
    inherits(GridyGrid, _HTMLElement);

    function GridyGrid() {
        classCallCheck(this, GridyGrid);
        return possibleConstructorReturn(this, (GridyGrid.__proto__ || Object.getPrototypeOf(GridyGrid)).apply(this, arguments));
    }

    createClass(GridyGrid, [{
        key: 'connectedCallback',
        value: function connectedCallback() {
            this.basePath = this.getAttribute('basePath') || './src';
            ...
            if (!this.dataSource) {
                var dataSourceEl = this.querySelector('gridy-data-source');
                if (dataSourceEl != null) {
                    if (!customElements.get('gridy-data-field')) {
                        customElements.define('gridy-data-source', GridyDataSource);
                    }
                    dataSourceEl.config();
            ...
            this.filters = [];
            var filters = document.querySelectorAll('gridy-filter');
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;
            ...
            var pager = this.querySelector('gridy-pager');
            if (pager !== null) {
                pager.dataSource = this.dataSource;
                pager.renderer = this.renderer;
                if (!pager.basePath) {
                    pager.basePath = this.basePath;
                }
                if (!pager.theme) {
                    pager.theme = this.theme;
                }
            ...
            var table = this.querySelector('gridy-table');
            if (table !== null) {
                table.dataSource = this.dataSource;
                table.renderer = this.renderer;
                table.pager = pager;
                if (!table.basePath) {
                    table.basePath = this.basePath;
                }
                if (this.filters && this.filters.length > 0) {
                ...
                if (this.onhrowclick) {
                    table.onhrowclick = this.onhrowclick;
                }
                this.table = table;
            } else {
            ...
            this.infos = [];
            var infos = this.querySelectorAll('gridy-table-info');
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;
            ...
            var spinner = this.querySelector('gridy-spinner');
            if (spinner !== null) {
                spinner.renderer = this.renderer;
                if (!spinner.theme) {
                    spinner.theme = this.theme;
                }
                if (!spinner.basePath) {
                    spinner.basePath = this.basePath;
                }
                spinner.tplPath = spinner.basePath + '/theme/' + spinner.theme + '/spinner.tpl.html';
                if (this.dataSource) {
                    if (this.dataSource instanceof DataSourceAjax) {
                        this.dataSource.addEventListener('dataFetchStarted', function (event) {
                            spinner.show();
                        });
                    } else {
                        this.dataSource.addEventListener('dataLoadStarted', function (event) {
                            spinner.show();
                        });
                    }
                    this.dataSource.addEventListener('dataLoaded', function (event) {
                ...
                if (!customElements.get('gridy-spinner')) {
                    customElements.define('gridy-spinner', GridySpinner);
                }
            }

            if (!customElements.get('gridy-filter')) {
                customElements.define('gridy-filter', GridyFilter);
            }
            if (!customElements.get('gridy-pager')) {
                customElements.define('gridy-pager', GridyPager);
            }
            if (!customElements.get('gridy-table')) {
                customElements.define('gridy-table', GridyTable);
            }
            if (!customElements.get('gridy-table-info')) {
                customElements.define('gridy-table-info', GridyTableInfo);
            }
            if (!customElements.get('gridy-data-field')) {
                customElements.define('gridy-data-field', GridyDataField);
            }

            if (this.dataSourceEl && this.dataSourceEl.getAttribute('datasource-type') === 'DataSourceLocal') {
...
exports.GridyGrid = GridyGrid;
exports.GridySpinner = GridySpinner;
exports.GridyTable = GridyTable;
exports.GridyTableInfo = GridyTableInfo;
exports.GridyPager = GridyPager;
exports.GridyFilter = GridyFilter;
exports.GridyDataSource = GridyDataSource;
exports.GridyDataField = GridyDataField;
exports.DataSourceLocal = DataSourceLocal;
exports.DataSourceAjax = DataSourceAjax;
exports.Renderer = Renderer;
exports.EventBus = EventBus;
exports.XmlHttpClient = XmlHttpClient;
exports.HgTemplateEngine = HgTemplateEngine;
exports.BaseTemplateEngine = BaseTemplateEngine;

return exports;

}({}));
//# sourceMappingURL=gridy-grid-legacy-bundle.js.map
