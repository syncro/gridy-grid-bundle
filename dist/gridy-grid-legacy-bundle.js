    ...
    createClass(GridyTable, [{
        ...
        value: function connectedCallback() {
            ...
            if (this.filters) {
                ...
                try {
                    for (var _iterator6 = this.filters[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
